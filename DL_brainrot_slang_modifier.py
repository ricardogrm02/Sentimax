...
# Sentiment groupings for brainrot slang
...
# Paths
model_path = "DL_brainrot_model.h5"
tokenizer_path = "DL_brainrot_tokenizer.pkl"
...
if os.path.exists(model_path) and os.path.exists(tokenizer_path) and os.path.exists(label_encoder_path):
    print("Loading existing DL brainrot model and tokenizer...")
    ...
    print("Training new DL brainrot model...")
    # Prepare brainrot/slang data
    df = pd.read_csv("train_brainrot_slang_data.csv")
    ...
    def build_bigru_model():
        ...
        return Model(inputs=input_layer, outputs=output_layer, name="BiGRU_Brainrot")
...
if __name__ == "__main__":
    user_text = input("Enter brainrot slang text to analyze polarity: ")
